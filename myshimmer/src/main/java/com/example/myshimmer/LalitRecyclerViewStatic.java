...
public class LalitRecyclerViewStatic extends RecyclerView {
    ...
    public LalitRecyclerViewStatic(Context context) {
        super(context);
        init(context, null);
    }

    public LalitRecyclerViewStatic(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public LalitRecyclerViewStatic(Context context, @Nullable AttributeSet attrs, int defStyle) {
